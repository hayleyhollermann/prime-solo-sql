...
--and a transactions_attempted of 0? 
...
--How do you get the username and account balance of the 3 users with the lowest balances, 
...
(username, city, transactions_completed, transactions_attempted, account_balance) VALUES 
('hayley', 'minneapolis', 99, 100, 5000000);
